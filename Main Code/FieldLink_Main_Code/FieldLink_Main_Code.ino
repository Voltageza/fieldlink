...
void writeDO() {
  digitalWrite(DO_LATCH, LOW);
  shiftOut(DO_DATA, DO_CLOCK, MSBFIRST, do_state);
  digitalWrite(DO_LATCH, HIGH);
}
...
void setup() {
  ...
  // Initialize DO outputs
  pinMode(DO_DATA, OUTPUT);
  pinMode(DO_CLOCK, OUTPUT);
  pinMode(DO_LATCH, OUTPUT);
  writeDO();
